...
namespace MovieLibrary
{
    ...
    public class Movie : IValidatableObject
    {
        ...
        public int Id { get; set; } // Public read, private write
        ...
        public IEnumerable<ValidationResult> Validate ( ValidationContext validationContext )
        {
            ...
            if (String.IsNullOrEmpty(Name)) // this.name
                yield return new ValidationResult("Name is required", new[] { nameof(Name) });
                             // Tield returning new validation result with message and string array (collection init syntax) containing a single string with name of Name
